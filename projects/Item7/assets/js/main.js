...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
      ...
      const scriptURL = 'https://script.google.com/macros/s/AKfycbxcqD3_oPzieVAWvPBYywQyuUF3knrhv4bWhjTuNWn7AiLOkSKn/exec';
...
function getCheckedValues() {
    const What_is_your_ethnicity = Array
  .from(document.querySelectorAll('input[type="checkbox"]'))
  .filter((checkbox) => checkbox.checked)
  .map((checkbox) => checkbox.value);
  document.getElementById("What_is_your_ethnicity?").value = What_is_your_ethnicity;
  }
